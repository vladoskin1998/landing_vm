...
export declare const PostsSchema: import("mongoose").Schema<Posts, import("mongoose").Model<Posts, any, any, any, import("mongoose").Document<unknown, any, Posts> & Omit<Posts & {
